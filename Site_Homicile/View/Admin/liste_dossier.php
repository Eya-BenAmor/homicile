	...
	<div id="wrapper">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="liste_dossier.php" class="active">Liste des dossiers médicaux</a></li>
								</ul>
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Dossiers médicaux</h3>
					<div class="row">
						<div class="col-md-6">
	 ...
	 <?php foreach ($dms as $raw) { 
	  ...
	  ?>
                                    ...
                                    <tr>
										<th scope="row"><?PHP echo $raw['id']; ?></th>
										<td><?PHP echo $raw['titre'];?> </td>
                                        <td><?PHP echo $patient['nom'].' '.$patient['prenom']; ?> </td>
                                        <td><?PHP echo $maladie['nom']; ?> </td>
										<td><a target="_blank" href="src/<?php echo $raw['fichier_pdf']; ?>"> <?php echo $raw['fichier_pdf']; ?> </a> </td>
