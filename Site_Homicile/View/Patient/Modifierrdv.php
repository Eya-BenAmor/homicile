            ...
            <section class="module">
                <div class="module-inner">
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="">Avoir rendez-vous</a></li>
                        <li><a href="historique_patient.php">Rendez-vous passés</a></li>
                ...
                <div class="content-panel">
                        ...
                        <?php
                              ...
                              $rdvC = new rdvC();
                              $liste = $rdvC->recupererrdv($_GET['id']);
        foreach ($liste as $row) {
         
          

    ?>
                        <form class="form-horizontal" action="Modif.php?id=<?PHP echo $_GET["id"];?>" name="id" method = "post">
                        ...
                        <select  class="form-control" name="etat" value="<?php echo $row['etat']; ?>" required>
                                  <option disabled="disabled" selected="selected"  ><?php echo $row['etat']; ?></option>
        ...
        foreach ($liste2 as $row_m) {
            ?>
                        <select  class="form-control" name="medecin" value="<?php echo $row['idm']; ?>" required>
                        <option disabled="disabled" selected="selected"><?php echo $row_m["nom"]." ".$row_m["prenom"].': '.$row_m["specialite"]; ?></option>
<?php
        
    
     $medecinC2 = new medecinC();
     $liste3 = $medecinC2->afficherM2();
        
        foreach ($liste3 as $row3) {
        echo '<option  value='.$row3["id"].'>'.$row3["nom"]." ".$row3["prenom"].': '.$row3["specialite"].'</option>';
        }
