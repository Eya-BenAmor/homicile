                        ...
                        <?php
                            if (isset($_SESSION['unserId'])) {
                                ...
                                <select  class='form-control'  name='genre' style='width: 500px;'>
                                    ...
                                    echo "<h5>Tel : ".$_SESSION['unserTel']. " </h5><input type='tel'  placeholder=' 123-456-7890' class='form-control' style='width: 500px;' name='tel' pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' required ><br>";
