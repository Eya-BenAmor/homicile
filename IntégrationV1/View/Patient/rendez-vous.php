...
if (isset($_POST['submit-rdv'])) {
			...
			$mail->SMTPAuth = true;                              
			$mail->Username = 'homicilesite505@gmail.com';                
			$mail->Password = 'homicilesiteweb505';                         
			$mail->SMTPSecure = 'tls';                           
			$mail->Port = 587;                                  

			$mail->setFrom('homicilesite505@gmail.com', 'Admin');
			$mail->addAddress($rowm["email"]);  

			$mail->addReplyTo('homicilesite505@gmail.com');
