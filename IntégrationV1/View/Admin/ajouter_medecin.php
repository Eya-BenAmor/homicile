			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="ajouter_medecin.php" class="active"><i class="lnr lnr-file-empty"></i> <span>Ajouter un médecin</span></a></li>
...
<form class="form-horizontal" action="verifier_ajout_medecin.php" role="form" method="post">
    ...
    <div class="form-group">
        ...
        <div class="form-group">
		<div class="col-sm-12">
            <select  class="form-control" id="specialite" name="specialite" style="height: 30px ! important;" required>
