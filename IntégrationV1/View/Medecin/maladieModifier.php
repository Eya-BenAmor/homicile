...
session_start();
  ...
  $mc = new MaladieC();
  $maladie = $mc->getMaladie($_GET['id']);


  if (isset($_POST) and isset($_POST['id']) and isset($_POST['nom']) and isset($_POST['description'])) {

    $m = new Maladie($_POST['id'],$_POST['nom'],$_POST['description']);
    $mc->modifierMaladie($m);
    echo '<script type="text/javascript">alert("Maladie modifier !")</script>';
      ...
      <section class="module">
          <div class="module-inner">
              ...
              <div class="content-panel">
                  <h2 class="title">Modifier une maladie<span class="pro-label label label-warning"></span></h2>
      ...
      <div class="form-style-2">
        ...
        <form method="post">
          ...
          <label for="nom">
            ...
            <input type="text" class="input-field" name="nom" value="<?php echo $maladie['nom']; ?>" />
          </label>
          <label for="description">
            <span>Description <span class="required">*</span></span>
            <textarea name="description" class="textarea-field"><?php echo $maladie['description']; ?></textarea>
          </label>
