...
<body>
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="liste_patient.php" class="active">Liste des patients</a></li>
   ...
   $liste = $patientC->afficherP_admin();
								   ...
								   <tr>
									   ...
									   <td>
										   ...
										   <ul class="list-inline m-0">
											   ...
											   <a href="supprimer_patient.php?id=<?PHP echo $row['id']; ?>" name="id" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>                                                  
											   </li>
										   </ul>
									   </td>
								   </tr>
