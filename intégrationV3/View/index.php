...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="2.php"> <img src="../images/logo.png" alt="">Restez chez vous, c'est à nous de venir</a>
      ...
      <?php
                                if (isset($_SESSION['unserId'])) {
                                  ?>
                                   <li class="nav-item active">
                                   <li>  <a class="nav-link" href='espace_patient.php'> <?php echo "Bonjour, ".$_SESSION['unserLastname'].""; ?></a></li>
                                   </li>
                                   <?php
  ...
  <header class="py-5 bg-image-full" style="background-image: url('http://localhost/PHP/ici/eya/images/acc1.png');" >
  ...
  <img src="http://localhost/PHP/ici/eya/images/depositphotos_1525631-stock-photo-successful-female-doctor.jpg" width="450"
         height="450">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 mt-5 mt-md-0">
                        <div class="foot-links">
                            ...
                            <ul class="p-0 m-0">
                                ...
                                <li><a href="S'enregistrer.php">S'enregistrer</a></li>
