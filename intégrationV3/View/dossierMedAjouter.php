   ...
   if (isset($_POST) and isset($_POST['maladie']) and isset($_POST['patient']) and isset($_POST['titre']) and isset($_POST['description']) ) {
    ...
    if(isset($_FILES['fileToUpload'])){
      ...
      // if(empty($errors)==true){
        ...
        $dmC = new DossierMedC();
        $dm = new DossierMed(NULL,$_POST['maladie'],$_POST['patient'],$_POST['titre'],$file_name,$_POST['description']);
        $dmC->ajouterDossierMed($dm);

        echo '<script type="text/javascript">alert("Dossier Medicale ajouter !")</script>';
      ...
      <section class="module">
          <div class="module-inner">
              <div class="side-bar">
                  ...
                  <nav class="side-menu">
                  <ul class="nav">
                      <li ><a href=""><span class="fa fa-user"></span> Liste de rendez-vous</a></li> 
                      ...
                      <li class="active" ><a href="dossierMedAjouter.php"><span class="fa fa-clock-o"></span>Dossiers médicaux</a></li>
              ...
              <div class="content-panel">
                  <h2 class="title">Ajouter un dossier médical<span class="pro-label label label-warning"></span></h2>
      ...
      <div class="form-style-2">
        ...
        <form method="post" enctype="multipart/form-data">
          <label for="nom">
            ...
            <input required type="text" class="input-field" name="titre" value="" />
          </label>
          <label for="patient"><span>Patient</span>
           ...
           <label for="fileToUpload">
            ...
            <input required type="file" class="input-field" id="fileToUpload" name="fileToUpload" value="" />
          </label>
          <label for="description">
            <span>Description <span class="required">*</span></span>
            <textarea required name="description" class="textarea-field"></textarea>
          </label>
