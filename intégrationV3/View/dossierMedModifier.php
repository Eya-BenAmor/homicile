          ...
          <div class="module-inner">
              <div class="side-bar">
                  ...
                  <ul class="nav">
                      ...
                      <li class="active" ><a href="dossierMedAfficher.php"><span class="fa fa-clock-o"></span>Dossiers médicaux</a></li>
        ...
        <form method="post" enctype="multipart/form-data">
          ...
          <label for="patient"><span>Patient</span>
            <select name="patient" class="select-field">
              ...
              <option <?php if ($p['id'] == $dossierMed['patient_id']) { echo "selected"; }?> value="<?php echo $p['id']; ?>"> <?php echo $p['nom']; ?> </option>
              <?php } ?>
            </select>
           </label>
