						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="liste_RDV_admin.php" class="active">Liste de rendez-vous</a></li>
								</ul>
	...
	$listerdv = $rdvC->afficherrdvS();
                                foreach ($listerdv as $rdv) {
                                  ...
                                  foreach ($liste2 as $row_m) {
									$liste3 = $patientC->afficherP($rdv['idp']);
									foreach ($liste3 as $row_p) {
                                  ?>
                                    <tr>
										<th scope="row"><?PHP echo $rdv['id']; ?></th>
										<td><?PHP echo $row_p['nom']. ' ' .$row_p['prenom']; ?> </td>
...
<td><?PHP echo $row_m['nom']. ' ' .$row_m['prenom'] .' '.$row_m['specialite']; ?> </td>
                                        ...
                                        <td>
                                            ...
                                            <ul class="list-inline m-0">
                                                ...
                                                <a href="supprimer_RDV_admin.php?id=<?PHP echo $rdv['id'];?>" name="id" class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>                                                  
                                                </li>
