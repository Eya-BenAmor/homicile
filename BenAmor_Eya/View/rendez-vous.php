...
if (
    ...
    if (
        ...
        $rdvC->ajouterrdv($rdv);
       // header('Location:AfficherAlbums.php');
    } else
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="input-group">
                            <input class="input--style-3 js-datepicker" type="text" placeholder="Date" name="date" required>
                        ...
                        <div class="p-t-10">
                            <button class="btn btn--pill btn--green" type="submit">Réserver</button>
                        </div>
                    </form>
                </div>
            </div>
