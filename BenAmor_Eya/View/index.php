...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#">Médecin</a>
          </li>
          <li class="nav-item">
  ...
  <div class="py-5 bg-image-full" style="background-image: url('http://localhost/projetV0/images/acc2.png');">
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Esprit 2020 projet web 2A18 </p>
    </div>
    <!-- /.container -->
  </footer>
