...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
  ...
  <section class="py-5">
    ...
    <section class="pb-5 header text-center">
      ...
      <form class="form-horizontal" action="verif_ajout_ordonnance.php" role="form" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <label class="radio-inline">
                                                    <input type="text" name="Médicament1" placeholder=" Médicament 1 (obligatoire)" class="form-control"required >
                                                </label>
                                            </div>
                                            <div class="col-sm-4">
                                                <label class="radio-inline">
