            ...
            <div class="module-inner">
                <div class="side-bar">
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"><a href="historique_patient.php"><span class="fas fa-history"></span>Rendez_vous passés</a></li>
                                ...
                                echo "<table>
                                    ...
                                    foreach ($liste3 as $row_o) {
                                        ...
                                        if ($remarque !== "") {
                                          ...
                                          echo '<td style="width: 40%;"> <a href="afficher_ordonnance.php" class="collapsible">ordonnace</a>
                                          <div class="content">';
