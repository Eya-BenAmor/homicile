        ...
        <section class="module">
            <div class="module-inner">
                ...
                <ul class="nav">
                    ...
                    <form class="form-horizontal" action="liste.php" method = "post">
                      <button class="btn btn-primary" style="margin-left: 14%; margin-top: 10%;"><span class="fa fa-user"></span> Liste des ordonnances</button>
                    </form>
                    ...
                    <form class="form-horizontal" action="ordonnance.inc.php" role="form" method="post">
                        <fieldset class="fieldset">
                            ...
                            $db = config::getConnexion();
                                ...
                                try {
                                    $liste2 = $db2->query($sql2);
                                    
                                    foreach ($liste2 as $row_p) {

                                   
                                      echo '<div class="form-group avatar"><button type="button" class="collapsible">'.$row_p['nom']." ".$row_p['prenom'].'</button><div class="content">';
                                      ...
                                      echo '<a href="ajouter_ordonnance.php" type="button"><span style="font-size:17px;cursor:pointer" onclick="openNav()">&#9998;</span> ajouter ordonnance </a></div>';
