                    ...
                    <form class="form-horizontal" action="" method = "post">
                        ...
                        <?php
                            if (isset($_SESSION['unserId'])) {
                                ...
                                echo "</fieldset><hr>";
                                echo "<h5>Email : ".$_SESSION['unserEmail']. "  </h5><input type='text'  placeholder='Nouvelle adresse email...' class='form-control' style='width: 500px;' name='email'> <br>";
                                echo "<h5>Date de naissance : ".$_SESSION['unserBirth']. "  </h5><input type='date'  placeholder='Date de naissance...' class='form-control' style='width: 500px;' name='datenaissance'><br>";
